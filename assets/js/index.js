...
const submit = () => {
    ...
    // window.location.href = window.location.host + '/pages/view.html'
...
const validateProduct = (dataEntered) => {
    console.log(dataEntered, "vall")
    if (dataEntered.pname == "") {
        alert("Please enter product name!")
        return false;
    }
    else if (dataEntered.pdesc == "") {
        dataEntered.pdesc = "<b>There is no description.</b>"
        return true;
    }
    else {
        return true
...
const insertProductData = (localStorage_getData) => {
    ...
    localStorage_getData.forEach((element) => {
        ...
        <h6 class="card-text text-truncate"  id="pdesc">Description : <br>${element.pdesc}</h6>
